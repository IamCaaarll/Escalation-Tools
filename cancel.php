<!--For Selecting the Items in CANCELLED LIST-->
<script type="text/javascript">
  ...
  $result = mysqli_query($conn,"SELECT * FROM shakeys_escalation_template_final where concern_type ='Cancellation' AND status = 'QUEUE' ORDER BY date_endorsed ASC");
