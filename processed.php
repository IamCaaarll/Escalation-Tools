<!--For Selecting the Items in PROCESSED LIST-->
...
include("Database/Connection.php");/*Database Connection*/
  ...
  $result = mysqli_query($conn,"SELECT * FROM shakeys_escalation_template_final where status = 'ACKNOWLEDGE' ORDER BY date_endorsed ASC");
