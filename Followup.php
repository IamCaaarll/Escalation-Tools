<!--For Selecting the Items in FOLLOW UP LIST-->
...
<?php
  ...
  $result = mysqli_query($conn,"SELECT * FROM shakeys_escalation_template_final where concern_type ='follow up' AND status = 'QUEUE' ORDER BY date_endorsed ASC");
